...
> ⚠️ **TEST FIXTURE — NOT A REAL PROJECT.** This folder is the test fixture for the ICM plugin's script suite (see `../../tests/`). Do not edit it as if it were your own work; copy `templates/pipeline/` to a new location instead.
>
> It demonstrates a 3-stage content pipeline (research → script → production). Replace the project name, identity, references, and outputs with your own work if you copy this. Keep the structure.
